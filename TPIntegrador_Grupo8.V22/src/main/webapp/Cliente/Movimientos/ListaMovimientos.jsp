...
<table class="min-w-full border border-gray-300 rounded-lg">
	<thead>
		<tr>
			...
			<th class="bg-gray-100 px-4 py-2 border-b border-gray-300 text-left">Detalle</th>
		</tr>
	</thead>
	...
	<tbody>
		...
		%>
		<tr>
			<td class="px-4 py-2 border-b border-gray-200"><%=mov.getIdMovimiento_mo()%></td>
			...
			<td class="px-4 py-2 border-b border-gray-200"><%=mov.getDetalle_mo()%></td>
		</tr>
		<%
		}
		}
